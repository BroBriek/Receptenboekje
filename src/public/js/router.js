...
(function(App) {
  ...
  function showView(viewName) {
    ...
    document.querySelectorAll('.nav-item').forEach(item => {
      ...
      // If we're on Settings, IngredientsManage, Tags, or Users, highlight the 'More' nav item
      if (itemTarget === viewName || (itemTarget === 'More' && ['More', 'Settings', 'IngredientsManage', 'Tags', 'Users'].includes(viewName))) {
